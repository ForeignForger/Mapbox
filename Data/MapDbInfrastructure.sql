...
CREATE TABLE map.Layers(Id INT NOT NULL IDENTITY(1,1), StringId VARCHAR(40) NOT NULL UNIQUE, MetadataOnly BIT NOT NULL, [Type] VARCHAR(20) NULL, Source NVARCHAR(MAX) NULL, popupTemplate NVARCHAR(MAX) NULL, LayerName NVARCHAR(50), [Order] INT NULL,
	PRIMARY KEY(Id));
...
CREATE TABLE map.LayerChildLayers(LayerId INT NOT NULL, ChildLayerId INT NOT NULL,
	...
	FOREIGN KEY(LayerId) REFERENCES map.Layers(Id),
	FOREIGN KEY(ChildLayerId) REFERENCES map.Layers(Id));
...
CREATE TABLE map.Controls(Id INT NOT NULL IDENTITY(1,1), StrintgId VARCHAR(30) UNIQUE, ControlTemplate NVARCHAR(MAX) NOT NULL, ControlName NVARCHAR(50), ControlData NVARCHAR(MAX) NULL,
	PRIMARY KEY(Id));
