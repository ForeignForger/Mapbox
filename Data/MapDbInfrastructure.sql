...
CREATE TABLE map.Controls(Id INT NOT NULL IDENTITY(1,1), StringId VARCHAR(30) UNIQUE, ControlTemplate NVARCHAR(MAX) NOT NULL, ControlName NVARCHAR(50) NOT NULL, ControlData NVARCHAR(MAX) NULL,
	PRIMARY KEY(Id));
